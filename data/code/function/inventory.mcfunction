...
tag @n[type=item,tag=inventory.drop,distance=..1] remove inventory.drop
...
execute if items entity @s hotbar.6 * unless items entity @s hotbar.6 book unless items entity @s hotbar.6 barrier run summon item ~ ~ ~ {Item:{id:"barrier",count:1},Tags:["inventory.drop"],PickupDelay:1s}
execute if items entity @s hotbar.6 * unless items entity @s hotbar.6 book unless items entity @s hotbar.6 barrier run item replace entity @n[type=item,tag=inventory.drop,distance=..1] container.0 from entity @s hotbar.6
execute if items entity @s hotbar.6 * unless items entity @s hotbar.6 book unless items entity @s hotbar.6 barrier run data modify entity @n[type=item,tag=inventory.drop,distance=..1] Owner set from entity @s UUID
tag @n[type=item,tag=inventory.drop,distance=..1] remove inventory.drop
item replace entity @s hotbar.6 with book[item_name='"Recipe Book"',lore=['{"text":"Right click to open the recipe list","color": "gray","italic":false}'],consumable={animation:"none",consume_seconds:0,has_consume_particles:false,sound:"minecraft:ambient.basalt_deltas.additions"}]
