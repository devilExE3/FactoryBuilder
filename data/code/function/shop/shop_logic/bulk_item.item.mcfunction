...
execute if items entity @s container.* *[custom_data~{shop:"crafter_5"}] run return run function code:shop/shop_logic/bulk/crafter_5
...
execute if items entity @s container.* *[custom_data~{shop:"generator.glass"}] run return run function code:shop/shop_logic/bulk/generator.glass
execute if items entity @s container.* *[custom_data~{shop:"generator.coal_block"}] run return run function code:shop/shop_logic/bulk/generator.coal_block
execute if items entity @s container.* *[custom_data~{shop:"generator.iron_axe"}] run return run function code:shop/shop_logic/bulk/generator.iron_axe
...
execute if items entity @s container.* *[custom_data~{shop:"generator.spruce_planks"}] run return run function code:shop/shop_logic/bulk/generator.spruce_planks
