...
execute if items entity @s weapon.offhand * if data entity @s equipment.offhand.components."minecraft:entity_data"{Tags:["place"]} run function code:shop/shop_logic/shop_sell
