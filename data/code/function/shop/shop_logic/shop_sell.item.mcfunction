...
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:entity_data"{Tags:["place.washer"]} run return run data modify storage numeral:io B set value [6969,0,0,0]
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:entity_data"{Tags:["place.crusher"]} run return run data modify storage numeral:io B set value [6969,0,0,0]
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:entity_data"{Tags:["place.flashbaker"]} run return run data modify storage numeral:io B set value [6969,0,0,0]
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:entity_data"{Tags:["place.sonic_zapper"]} run return run data modify storage numeral:io B set value [6969,0,0,0]
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:entity_data"{Tags:["place.enchanter"]} run return run data modify storage numeral:io B set value [6969,0,0,0]
...
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:entity_data"{Tags:["place.generator.netherrack"]} run return run data modify storage numeral:io B set value [6969,0,0,0]
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:entity_data"{Tags:["place.generator.end_stone"]} run return run data modify storage numeral:io B set value [6969,0,0,0]
return fail