...
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:entity_data"{Tags:["place.air_conveyor"]} run return run data modify storage numeral:io B set value [1000000,0,0,0]
