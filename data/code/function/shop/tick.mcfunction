...
tag @s add old_score
execute as @s[tag=holding_shop] as @n[type=chest_minecart,tag=shop,distance=..3] if score @s id = @p[tag=old_score] id run function code:shop/shop_logic/minecart_tick
