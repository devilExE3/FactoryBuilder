summon chest_minecart ~ ~ ~ {Invulnerable:true,Silent:true,NoGravity:true,CustomDisplayTile:true,Tags:["shop","shop.this"],CustomName:'{"text":"Shop"}',CustomNameVisible:false}
