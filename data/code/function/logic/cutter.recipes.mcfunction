...
execute if data entity @s item{id:"minecraft:birch_log"} run scoreboard players set #mul math 4
execute if data entity @s item{id:"minecraft:birch_log"} run return run data modify entity @s item.id set value "minecraft:birch_planks"
execute if data entity @s item{id:"minecraft:birch_planks"} run scoreboard players set #mul math 2
execute if data entity @s item{id:"minecraft:birch_planks"} run return run data modify entity @s item.id set value "minecraft:birch_slab"
