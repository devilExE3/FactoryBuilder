...
data modify block 29999998 -64 0 Items append value {id:"light_gray_stained_glass_pane",count:1,components:{hide_tooltip:{}},Slot:8}
...
data modify block 29999998 -64 0 Items append value {id:"light_gray_stained_glass_pane",count:1,components:{hide_tooltip:{}},Slot:17}
...
data modify block 29999998 -64 0 Items append value {id:"light_gray_stained_glass_pane",count:1,components:{hide_tooltip:{}},Slot:26}