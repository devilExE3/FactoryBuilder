...
data modify block 29999998 -64 0 Items append value {id:"blast_furnace",count:1,components:{item_name:'"Furnace"',lore:['[{"text":"Price: ","color":"gray","italic":false},{"text":"$1.0k","color":"green","italic":false}]'],custom_data:{shop:"furnace",shop_item:1b}},Slot:5}
data modify block 29999998 -64 0 Items append value {id:"crafting_table",count:1,components:{item_name:'"Crafter (2 inputs)"',lore:['[{"text":"Price: ","color":"gray","italic":false},{"text":"$500.0k","color":"green","italic":false}]'],custom_data:{shop:"crafter_2",shop_item:1b}},Slot:6}
data modify block 29999998 -64 0 Items append value {id:"crafter",count:1,components:{item_name:'"Crafter (3 inputs)"',lore:['[{"text":"Price: ","color":"gray","italic":false},{"text":"$100.0M","color":"green","italic":false}]'],custom_data:{shop:"crafter_3",shop_item:1b}},Slot:7}
...
data modify block 29999998 -64 0 Items append value {id:"coal_ore",count:1,components:{item_name:'"Coal Farm"',lore:['[{"text":"Price: ","color":"gray","italic":false},{"text":"$100.0k","color":"green","italic":false}]'],custom_data:{shop:"generator.coal",shop_item:1b}},Slot:11}
data modify block 29999998 -64 0 Items append value {id:"birch_sapling",count:1,components:{item_name:'"Birch Farm"',lore:['[{"text":"Price: ","color":"gray","italic":false},{"text":"$1.0B","color":"green","italic":false}]'],custom_data:{shop:"generator.birch",shop_item:1b}},Slot:12}
data modify block 29999998 -64 0 Items append value {id:"copper_ore",count:1,components:{item_name:'"Copper Farm"',lore:['[{"text":"Price: ","color":"gray","italic":false},{"text":"$100.0B","color":"green","italic":false}]'],custom_data:{shop:"generator.copper",shop_item:1b}},Slot:13}
data modify block 29999998 -64 0 Items append value {id:"iron_ore",count:1,components:{item_name:'"Iron Farm"',lore:['[{"text":"Price: ","color":"gray","italic":false},{"text":"$5.0T","color":"green","italic":false}]'],custom_data:{shop:"generator.iron",shop_item:1b}},Slot:14}
