...
scoreboard players set #underflow numeral 0
execute if score #A numeral matches ..-1 run scoreboard players set #underflow numeral 1
execute if score #A numeral matches ..-1 run scoreboard players operation #A numeral += #1b numeral
...
scoreboard players operation #A numeral -= #B numeral
scoreboard players operation #A numeral -= #underflow numeral
scoreboard players set #underflow numeral 0
execute if score #A numeral matches ..-1 run scoreboard players set #underflow numeral 1
execute if score #A numeral matches ..-1 run scoreboard players operation #A numeral += #1b numeral
